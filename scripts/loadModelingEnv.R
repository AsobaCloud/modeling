...
lib<-c("devtools","SDMtune","INWT/INWTUtils","magrittr","caret","gbm","glmnet","randomForest","kernlab","doParallel","tidyverse","knitr","asobalife/lookr","rJava","dplyr","snowflakedb/dplyr-snowflakedb","zeallot","glue","httr","jsonlite","bigrquery","rich1000/lookr")
