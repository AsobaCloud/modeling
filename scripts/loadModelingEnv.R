...
lib<-c("devtools","tidyr","SDMtune","INWT/INWTUtils","Quandl","magrittr","caret","gbm","glmnet","randomForest","kernlab","doParallel","tidyverse","knitr","asobalife/lookr","rJava","dplyr","dbplyr","zeallot","glue","httr","jsonlite","bigrquery","rich1000/lookr")
